...
Ext.define('LoginApp.view.Notification', {
    extend: 'Ext.Container',
    alias: 'widget.notification',

    requires: [
        'LoginApp.view.LoginPanelViewModel2',
        'Ext.Button',
        'Ext.menu.Menu',
        'Ext.menu.Item',
        'Ext.Label',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            data: [
                                {
                                    title: 'Giới thiệu dự án Tille Residents',
                                    time: '2 giờ trước',
                                    icon: 'fa fa-circle',
                                    unread: 'unread-title'
                                },
                                {
                                    title: 'Thông báo thanh toán đợt 9',
                                    time: '10 giờ trước',
                                    icon: ''
                                },
                                {
                                    title: 'Thông báo mở bán block D',
                                    time: '15 giờ trước',
                                    icon: ''
                                },
                                {
                                    title: 'Ưu đãi giảm giá 20 tại Le Residents',
                                    time: '15 giờ trước',
                                    icon: 'fa fa-circle',
                                    unread: 'unread-title'
                                },
                            ...
                            layout: 'vbox',
                            itemTpl: [
                                '<div class=\'notif-title {unread}\'><i class=\'notif-icon-list {icon}\'></i> {title}</div>',
